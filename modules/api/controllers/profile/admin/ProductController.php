...
class ProductController extends BaseController
{
    ...
    public function actionAdd()
    {
        ...
        if ($productAddition->is_purchase == 'true') {
            ...
            $price = $product->productFeature->is_weights == 1 ? $product->productFeature->productPrices[0]->member_price * $product->productFeature->volume : $product->productFeature->productPrices[0]->member_price;
            // $price = $product->productFeature->productPrices[0]->member_price;
