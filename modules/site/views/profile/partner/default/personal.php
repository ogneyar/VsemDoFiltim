...
<?php $form = ActiveForm::begin([
    ...
    <?= $form->field($model, 'city')->widget(SelectizeDropDownList::className(), [
        'items' => ArrayHelper::map(City::find()->orderBy(['name' => SORT_ASC])->all(), 'id', 'name'),
        'options' => [
            'readonly' => true,
        ],
    ]) ?>
    ...
    <div class="row">
        <div class="col-md-offset-2 col-md-6">
            <p>Предоставление неверных данных влечёт за собой автоматическое исключение из числа партеров.</p>
        </div>
    </div>
