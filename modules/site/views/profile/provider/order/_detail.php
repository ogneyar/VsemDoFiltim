...
<div class="order-index">
    <?php foreach ($dataProvider->getModels() as $model): ?>
        ...
        <p style="text-decoration: underline;">Заказчик: <strong><?= empty($model->role) ? "ГОСТЬ" : "УЧАСТНИК" ?></strong> <a href="<?= Url::to(['/site/search/search?fio=' . $model->user->lastname . "+" . $model->user->firstname . "+" . $model->user->patronymic]) ?>"><?= Html::encode($model->fullName) ?> № Регистрации: <?= $model->user->number ?></a></p>
