...
$this->title = $title;
$this->params['breadcrumbs'][] = ['label' => 'Заказы моих участников', 'url' => Url::to(['/profile/partner/member/order'])];
$this->params['breadcrumbs'][] = $this->title;

$addProductUrl = Url::to(['/api/profile/partner/product/add']);
$editAccountUrl = Url::to(['/profile/partner/member/account']);
    ...
    <div class="form-group field-orderform-product">
        ...
        <?= Select2::widget([
            ...
            'pluginOptions' => [
                ...
                'ajax' => [
                    'url' => Url::to(['/api/profile/partner/product/search']),
                    'dataType' => 'json',
